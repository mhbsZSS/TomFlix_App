...
![Tela de Login](caminho/para/sua/imagem_login_atividade1.png)

**2. Catálogo de Filmes e Integração TMDB:**
![Tela do Catálogo](caminho/para/sua/imagem_catalogo_atividade1.png)

**3. Tabela de Usuários no Banco de Dados:**
![Banco de Dados](caminho/para/sua/imagem_banco_atividade1.png)
...
![E-mail no Mailtrap](caminho/para/sua/imagem_mailtrap.png)

**2. Tela de Redefinição de Senha:**
*Interface padronizada que injeta o token temporal oculto.*
![Nova Senha](caminho/para/sua/imagem_tela_nova_senha.png)
...
![Erro de Token Inválido](caminho/para/sua/imagem_erro_token.png)

**4. Notificação de Sucesso:**
*Comprova a sincronização do backend com a interface, exibindo alerta verde após a troca da senha.*
![Sucesso na Troca de Senha](caminho/para/sua/imagem_sucesso_senha.png)
